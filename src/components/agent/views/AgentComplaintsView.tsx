...
interface AgentComplaintsViewProps {
...
export const AgentComplaintsView: React.FC<AgentComplaintsViewProps> = ({
  complaints,
  onReplyComplaint,
  onAddComplaint,
}) => {
      ...
      <div className="flex flex-col items-start justify-between gap-4 border-b border-border pb-5 sm:flex-row sm:items-center">
        <div className="min-w-0">
          ...
          <p className="mt-2 max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Direct communication with SDH Agent Support team. We aim to respond
            within 24 hours for commission, tier, and store-related issues.
          </p>
        </div>
            ...
            <div className="relative flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <DialogDescription className="mt-1 max-w-sm text-xs leading-relaxed">
                  Submit a new ticket to SDH Agent Support. We'll respond within
                  24 hours.
                </DialogDescription>
              </div>
            </div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="tier_dispute">
                            Tier Progress Dispute
                          </SelectItem>

                          <SelectItem value="order_problem">
                            Order Delivery Problem
                          </SelectItem>

                          <SelectItem value="pricing_error">
                            Pricing / Margin Error
                          </SelectItem>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Textarea
                        ...
                        rows={5}
                        required
                        placeholder="Provide details of what happened, relevant order numbers, timestamps..."
                        value={ticketMessage}
                      ...
                      <p className="text-[10px] leading-relaxed text-muted-foreground">
                        Include order references, timestamps, and any relevant
                ...
                <div className="flex items-start gap-2.5 rounded-2xl border border-amber-500/20 bg-amber-500/5 p-3.5">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[10px] leading-relaxed text-muted-foreground">
                      Agent Support team typically responds within 24 hours.
